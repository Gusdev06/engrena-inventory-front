...
import type { RegisterStartTimeProps } from "@/services/entrena-inventory-api/types";
...
export default function ClockForm() {
  ...
  const { mutateAsync } = useMutation({
    mutationKey: ["apiInventory.attendance"],
    mutationFn: async (props: RegisterStartTimeProps) => {
      const response = await apiInventory.registerStartTime({
        rfid: props?.rfid,
